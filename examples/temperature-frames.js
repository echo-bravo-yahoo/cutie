...
// transform:javascript, which compiles this file into a function taking
// `message`, `stash`, `error`, `task`, `module`, and `env`; what it returns is
// the message that goes on to the next step.
var MIN = 60;
var MAX = 95;
